...
def saveText():
    for xliffItem in xliffItemList:
        for excelItem in excelItemList:
            if xliffItem.sourceStr == excelItem.sourceStr and xliffItem.transStr != excelItem.transStr:
...
def main():
    ...
    saveText()
    global is_push
    subprocess.call(["xcodebuild -importLocalizations -localizationPath /Users/zhaoxiang/Desktop/myXliff/ja.xliff -project /Users/zhaoxiang/Desktop/InternDemo/InternDemo/InternDemo.xcodeproj"],
                                                shell=True)
